...
class ContactSupportPage extends StatelessWidget {
  ...
  void _sendContact(BuildContext context) async {
    ...
    try {
      final responseMsg = await Api.contactUs(name: name, email: email, body: message);
          ...
          child: SingleChildScrollView(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Text('Email Us', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Color(0xFFDAA520))),
                  SizedBox(height: 24),
                  TextField(
